...
# 大枠のデザイン
## package/src/app/layout.tsx内
```
Root layoutファイル
import { DashboardContextProvider } from './context/DashboardContext';
```

## package/src/app/(DashboardLayout)/layout.tsx内の下記にて実施
...
# sidebar
```
package/src/app/(DashboardLayout)/layout/sidebar/MenuItems.tsxにある
.js と上位互換の .jsx
.tsがJSの上位互換(TypeScript)ファイルで、.tsxが.jsxの上位互換(TypeScript)ファイルにあたる
```


el.app/">Flexy Admin Nextjs Free</a>
